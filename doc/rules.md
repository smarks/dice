...
For example, when an attribute is references in a formula
   ...
   A roll of 19, 20 - dex check to trip 
   A roll exactly close by 1 
   A roll over dex + footwork but less than 19 no range change. 
   Roll under dex + footwork skill close by 2
...
Allow you to strike twice simultaneously or parry twice simultaneously or parry and strikesimultaneously
...
### Min and Max Rolls
0-2 dex check or drop weapon
20 **DO NOT** always succeed 
But if you roll maxim (e..g nat 20) and would succeed apply these bonuses 
- 20 to hit x damage 
- 20 to critical bleeding (see table) 
Exactly check for breakage

### Critical Hits
If you roll a nat 20 and a nat 20 would hit, you've scored yourself as nasty critical hit. Use this table to see just how nasty. 
Roll a D20 
...
### Demon Die
Roll a D6
If you roll a 1 or 6 you keep rolling until you roll 2-5 either subtracting -1 or adding 5 as you progress. 
If you roll 2-5 that's the value. 

In other words:
Roll a d6
If you roll 1, roll again subtracting one from the result. 
If you roll 2-5 that's the number to use 
If you roll a 6 roll again adding 5 to that number. 
